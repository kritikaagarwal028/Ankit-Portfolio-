...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black">
      ...
      <section className="relative h-screen flex flex-col justify-center px-6 overflow-hidden pt-20">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          >
            ...
            <h1 className="text-7xl md:text-[110px] font-bold leading-[0.85] tracking-tighter mb-8 max-w-4xl">
              BROADCAST <br />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-end">
              <div className="space-y-6">
                ...
                <p className="text-lg font-light leading-relaxed max-w-lg opacity-60">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-wrap gap-2">
                  {ANKIT_DATA.skills.slice(0, 4).map(skill => (
                    <span key={skill} className="px-4 py-2 border border-current/20 rounded-sm text-[10px] uppercase font-bold tracking-widest bg-current/5">
                      {skill}
                    </span>
                  ))}
                </div>
      ...
      <section className="px-6 py-12">
        <div className="max-w-7xl mx-auto">
          <div 
            ...
            onClick={() => setSelectedVideo({ title: "2024 Showreel", videoUrl: "https://youtu.be/wosWXTt0Egs", category: "Reel" })}
          >
            <img 
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <motion.div 
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                className="w-24 h-24 rounded-full bg-white text-black flex items-center justify-center shadow-2xl relative z-10"
              >
                <Play fill="black" size={32} />
              </motion.div>
              <div className="mt-8 text-center relative z-10">
                <span className="text-[10px] font-bold uppercase tracking-[0.5em] mb-2 block text-white">Play Showreel</span>
                <h3 className="text-4xl md:text-6xl font-black font-serif italic text-white">ANKIT KESHARI / 2024</h3>
              </div>
            </div>
            
            <div className="absolute bottom-6 left-6 flex gap-4 text-[8px] font-bold uppercase tracking-widest text-white/40">
              <span>HD 4K</span>
              <span>•</span>
      ...
      <section id="about" className="py-32 px-6 border-b border-current/5">
        <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg opacity-60 max-w-md leading-relaxed mb-8">
              ...
              <div className="flex flex-wrap gap-3">
                {ANKIT_DATA.skills.map(skill => (
                  <span key={skill} className="px-4 py-2 border border-current/10 text-[10px] uppercase font-bold tracking-widest bg-current/5">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div className="grid gap-6 p-8 bg-white dark:bg-black border border-current/10 rounded-sm shadow-xl">
      ...
      <section className="py-32 px-6 bg-zinc-50 dark:bg-zinc-900/50">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
          <div className="w-full md:w-5/12 aspect-[4/5] relative overflow-hidden rounded-sm grayscale group bg-zinc-100 dark:bg-zinc-900 border border-current/10">
            <img 
              src="/src/assets/images/professional_portrait_1778996470619.png" 
              alt="Ankit Keshari"
          ...
          <div className="flex-1 space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl font-bold leading-tight tracking-tighter">THE INTERSECTION OF <br /><span className="font-serif italic font-light">JOURNALISM</span> & PRODUCTION</h2>
            <p className="text-xl opacity-70 leading-relaxed font-light">
              {ANKIT_DATA.summary}
            </p>
            <div className="grid grid-cols-2 gap-12 pt-8 border-t border-current/10">
              <div className="space-y-2">
                <div className="text-[10px] font-bold uppercase tracking-widest opacity-40">Core Philosophy</div>
                <div className="text-sm font-medium">Authoritative storytelling through precision technology.</div>
              </div>
              <div className="space-y-2">
                <div className="text-[10px] font-bold uppercase tracking-widest opacity-40">Industry Presence</div>
                <div className="text-sm font-medium">15+ Years of Leadership across National & Regional Networks.</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Featured Categories */}
      <section className="py-32 px-6 border-b border-current/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {ANKIT_DATA.categories.map((cat) => (
              <div key={cat.title} className="p-8 border border-current/10 hover:bg-current/2 transition-colors space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  {"description" in cat && <div className="text-xs opacity-60">{cat.description}</div>}
      ...
      <section id="work" className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-24">
            ...
            <h2 className="text-6xl md:text-8xl font-bold tracking-tighter">CASE <span className="font-serif italic font-light">STUDIES</span></h2>
          </div>
              ...
              >
                <div className="lg:col-span-5 space-y-8">
                  <div className="space-y-2">
                    ...
                    <h3 className="text-4xl font-serif italic text-balance">{cs.title}</h3>
                  </div>
                  ...
                  <div className="pt-6 border-t border-current/10 flex flex-wrap gap-3">
      ...
      <section id="process" className="py-32 px-6 bg-black text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="mb-24">
            ...
            <h2 className="text-5xl md:text-7xl font-bold tracking-tight">PROFESSIONAL <br /><span className="font-serif italic font-light opacity-60">WORKFLOW</span></h2>
          </div>
            ...
            {ANKIT_DATA.productionProcess.map((step, i) => (
              <div key={step} className="flex-1 group">
                <div className="h-[2px] w-full bg-white/10 mb-8 relative">
                   <div className="absolute top-[-4px] left-0 w-2 h-2 rounded-full bg-white group-hover:scale-150 transition-transform" />
                </div>
                <div className="space-y-4">
                  <div className="text-[10px] font-mono opacity-30">0{i + 1}</div>
                  <h4 className="text-sm font-bold uppercase tracking-[0.2em]">{step}</h4>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-24">
            <div className="space-y-12">
              <div>
                ...
                <h2 className="text-5xl font-bold tracking-tight">TECHNICAL <br /><span className="font-serif italic font-light">MASTERY</span></h2>
              </div>
              
              <div className="space-y-10">
                {Object.entries(ANKIT_DATA.technicalMastery).map(([category, tools]) => (
                  <div key={category} className="space-y-4">
                    <h3 className="text-[10px] font-bold uppercase tracking-[0.4em] border-l-2 border-current pl-4 mb-6">{category.replace(/([A-Z])/g, ' $1')}</h3>
                    <div className="flex flex-wrap gap-2">
                      {tools.map(tool => (
                        <span key={tool} className="px-5 py-3 bg-zinc-50 dark:bg-zinc-900 border border-current/5 text-xs font-bold uppercase tracking-widest hover:border-current/20 transition-colors">
                          {tool}
                        </span>
                      ))}
                    </div>
            ...
            <div className="space-y-12 bg-zinc-100 dark:bg-white/5 p-12 rounded-sm self-start">
               <div>
                <span className="text-[10px] font-bold uppercase tracking-[0.4em] opacity-40 mb-4 block">Mentorship</span>
                <h3 className="text-3xl font-bold tracking-tight font-serif italic mb-6">Media Education & Studio Leadership</h3>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={item} className="flex gap-4 items-center">
                       ...
                       <span className="text-xs uppercase font-bold tracking-widest opacity-80">{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="pt-12 border-t border-current/10">
                 <div className="text-[10px] font-bold uppercase tracking-[0.4em] opacity-40 mb-8 block">Organizations Worked With</div>
                 <div className="grid grid-cols-2 gap-8">
                    {ANKIT_DATA.organizations.map(org => (
                      <div key={org.name} className="space-y-1">
                        ...
                        <div className="text-[10px] opacity-40 uppercase tracking-widest">{org.type}</div>
                      </div>
                    ))}
                 </div>
              </div>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-32 px-6 border-t border-current/10">
        <div className="max-w-7xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-6xl md:text-[100px] font-bold tracking-tighter mb-12">
              CONTACT <br />
              <span className="font-serif italic font-light opacity-60">PROPOSAL</span>
            </h2>
            
            <div className="flex flex-col md:flex-row items-center justify-center gap-12">
              <a href={`mailto:${ANKIT_DATA.contact.email}`} className="group flex flex-col items-center">
                <div className="w-20 h-20 rounded-full border border-current/10 flex items-center justify-center group-hover:bg-black group-hover:text-white dark:group-hover:bg-white dark:group-hover:text-black transition-all mb-4">
                  <Mail size={24} />
                </div>
                <span className="text-[10px] font-bold uppercase tracking-[0.3em]">Direct Email</span>
                <span className="text-sm opacity-50 mt-1">{ANKIT_DATA.contact.email}</span>
              </a>
              
              <a href={`https://${ANKIT_DATA.contact.linkedin}`} target="_blank" rel="noreferrer" className="group flex flex-col items-center">
                <div className="w-20 h-20 rounded-full border border-current/10 flex items-center justify-center group-hover:bg-black group-hover:text-white dark:group-hover:bg-white dark:group-hover:text-black transition-all mb-4">
                  <Linkedin size={24} />
                </div>
                <span className="text-[10px] font-bold uppercase tracking-[0.3em]">Professional Node</span>
                <span className="text-sm opacity-50 mt-1">LinkedIn Profile</span>
              </a>

              <a href={`https://${ANKIT_DATA.contact.youtube}`} target="_blank" rel="noreferrer" className="group flex flex-col items-center">
                <div className="w-20 h-20 rounded-full border border-current/10 flex items-center justify-center group-hover:bg-black group-hover:text-white dark:group-hover:bg-white dark:group-hover:text-black transition-all mb-4">
                  <Video size={24} />
                </div>
                <span className="text-[10px] font-bold uppercase tracking-[0.3em]">Documentary Link</span>
                <span className="text-sm opacity-50 mt-1">YouTube Portfolio</span>
              </a>
            </div>
          </motion.div>
        </div>
      ...
      <footer className="py-12 border-t border-current/5 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-[10px] font-bold uppercase tracking-[0.4em] opacity-40">
          <div>© 2024 ANKIT KESHARI — PORTFOLIO</div>
